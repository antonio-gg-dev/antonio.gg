...
import { isPresetThemeId, Theme, ThemeId } from '@/config/Theme'
...
export default {
  ...
  decorators: [
    (story, context) => {
      const themeId: unknown = context.globals.theme
      const theme = isPresetThemeId(themeId) ? availableThemes[themeId] : availableThemes[ThemeId.Mambo]
